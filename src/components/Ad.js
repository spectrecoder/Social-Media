...
export default function Ad() {
    return (
        <div className="ad h-64 bg-white rounded-lg overflow-hidden mb-8 relative overlay">
            ...
            <div className="goal absolute bottom-8 right-10 text-white flex gap-3 items-center cursor-pointer bg-red-500 py-2 px-3 rounded-full border-2 border-red-500 border-solid hover:border-red-500 hover:bg-white group transition duration-300">
