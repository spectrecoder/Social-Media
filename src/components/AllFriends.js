...
export default function AllFriends({open, uid, spanRef, sec__spanRef}) {
    ...
    },[lists, spanRef, sec__spanRef])

    return (
        <div className={`friendList trans absolute top-112 md:top-110 left-0 lg:top-105 lg:left-46 bg-white w-full sm:w-89 shadow-xl border border-gray-200 border-solid max-h-89 ${open?'friendList__show':'friendList__hide'} overflow-y-scroll hideScrollBar`}>
