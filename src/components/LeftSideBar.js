...
export default function LeftSideBar({leftSide}) {
    return (
        <section ref={leftSide} className="leftSideBar h-screen md:w-32 w-28 bg-white fixed top-0 lg:left-0 -left-32 shadow-md lg:pt-44 pt-64 text-center overflow-y-scroll hideScrollBar trans z-40">
