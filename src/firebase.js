...
export {googleProvider, collection, addDoc, db, onSnapshot, serverTimestamp,query,orderBy, storage,ref,uploadBytesResumable,getDownloadURL,deleteDoc, doc, deleteObject, auth, createUserWithEmailAndPassword, signInWithEmailAndPassword, updateProfile, onAuthStateChanged, signOut, signInWithPopup }